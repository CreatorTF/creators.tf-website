...
// 5 Seconds.
const CONTRACKER_REFRESH_INTERVAL = 5 * 1000;
...
function CEContracker_GotoQuest(quest, interval = QUEST_AUTOPILOT_INTERVAL, preview = false) {
    ...
    let hEndPage = hQuest.parentElement;
...
function CEContracker_ShowPreview(quest) {
    ...
    switch (side)
    {
        case PREVIEW_LEFT: posX = quest.offsetLeft - el.offsetWidth - OFFSET_X; break;
        case PREVIEW_RIGHT: posX = quest.offsetLeft + quest.offsetWidth + OFFSET_X; break;
    }
    el.m_nSide = side;
...
function CEContracker_AdjustPreviewOffset(preview)
{
    ...
    {
        case PREVIEW_RIGHT: sPoints = `50,${iOffsetY} 0,${iOffsetY + 10} 50,${iOffsetY + 20}`; break;
        case PREVIEW_LEFT: sPoints = `354,${iOffsetY} 404,${iOffsetY + 10} 354,${iOffsetY + 20}`; break;
    }
