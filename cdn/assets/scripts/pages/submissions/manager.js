class CTFSubmissionsManager {
  ...
  OpenHintModal() {
    ...
    Creators.Actions.Modals.alert({
      name: "One more thing...",
      innerHTML: `<p>Your new submission looks great, but it may look even better if you make some changes to its settings. By clicking the button below, you will be redirected to the settings page for this submission.</p>
        <p>Please carefully read through each setting and accurately set the relevent parameters for your submission. This is important for your submission to be visible and voted on.</p>`,
      buttons: [{
        value: "Close"
      }, {
        ...
        icon: "label",
        onclick: () => {
          document.location.href = `/submission/${this.id}/edit`;
        }
      }]
    });
  }
