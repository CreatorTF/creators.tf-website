...
class API {
	...
	public function fetch_user() {
		...
		return $this->get_data('identity?include=memberships&fields'.urlencode('[user]').'=full_name,image_url,url,email');
	}
